@extends('layouts.main',['activePage' => 'sensors','titlePage' => 'Nuevo Sensor'])
@section('content')
<div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <form method="post" action="{{route('sensors.store')}}"  class="form-horizontal">
                    @csrf
                    <div class="card ">
                        ...
                        <div class="card body">
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <input class="form-control" name="state" type="text" placeholder="Ej: Funcionando, Detenido" required="true" aria-required="true" autofocus/>
                                </div>
                                
                                <label class="col-sm-2 col-form-label">{{ __('Condicion del Sensor') }}</label>
                                <div class="col-sm-3">
                                    <input class="form-control" name="condition_sensor" type="text" placeholder="{{ __('Ej: En revision, reparado') }}"  required autofocus/>
                                </div>                             
                            </div>
                            <div class="row" style="margin-top:30px" >
                                <label  class="col-sm-2 col-form-label" style="margin-left:50px" >Tipo</label>
                                <div class="col-sm-3">
                                    <input class="form-control" name="type" type="text" placeholder="Ej: Caudalimetro,Barometrico, Regulador de Valvula " required="true" aria-required="true" autofocus/>
                                </div>
