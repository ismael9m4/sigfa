    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                ...
                @endif
                <form method="post" action="{{route('pipelines.store')}}"  class="form-horizontal">
                    @csrf
                    <div class="card ">
                        <div class="card-header card-header-secundary" style="background-color:#F44336">
                            <h4 class="card-title">{{ __('Nueva Tuberia') }}</h4>
                        ...
                        <div class="card body">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <input class="form-control" name="positiong" type="text" placeholder="Ingrese ubicacion" aria-required="true" autofocus value="{{old('positiong')}}"/>
                                </div>                             
                            </div>
                            ...
                            <div class="row" style="margin-top:30px" >
                                ...
                                <select name="material" class="col-sm-3">
                                    ...
                                    <div class="col-sm-3">
                                        <input class="form-control" name="diameter" type="number" placeholder="Ingrese diametro en mm"  min="0" max="15000" step="0.01" aria-required="true" autofocus value="{{old('diameter')}}"/>
                                    </div>                                                
                            </div>
                            ...
                            <div class="row" style="margin-top:30px" >
                                ...
                                <div class="col-sm-3">
                                        <input class="form-control" name="thickness" type="number" placeholder="Ingrese espesor en mm" min="0" max="15000" step="0.01"  aria-required="true" autofocus value="{{old('thickness')}}"/>
                                    </div>  
                                
                                    <label for="length" class="col-sm-2 col-form-label" style="margin-left:50px" >Longitud(m)</label>
                                    <div class="col-sm-3">
                                        <input class="form-control" name="length" type="number" placeholder="Ingrese longitud en m" aria-required="true" autofocus value="{{old('length')}}"/>
                                    </div>                                                
                            </div>
                            <div class="row" style="margin-top:30px" >
                                <label for="depth_earth" class="col-sm-2 col-form-label" style="margin-left:50px" >Profundidad(m)</label>
                                <div class="col-sm-3">
                                        <input class="form-control" name="depth_earth" type="number" placeholder="Ingrese profundidad en m"  aria-required="true" autofocus value="{{old('depth_earth')}}"/>
                                    </div>  
                            ...
                            <div class="row" style="margin-top:30px" >
                                ...
                                <div class="col-sm-6">
                                        <input class="form-control" name="life_time" type="number" placeholder="Ingrese tiempo de vida de la tuberia en años"  aria-required="true" autofocus value="{{old('life_time')}}"/>
                                    </div>                                               
                            </div>
