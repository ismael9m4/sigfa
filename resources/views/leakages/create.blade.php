...
<div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <form method="post" action="{{route('leakages.store')}}"  class="form-horizontal">
                    @csrf
                    <div class="card ">
                        ...
                        <div class="card body">
                            <div class="row">
                                <div class="row" style="margin-top:30px" >
                                    <label for="fk_device" class="col-sm-2 col-form-label" style="margin-left:50px" >Categoria</label>
                                    <div class="col-sm-3">
                                ...
                                <div class="col-sm-3">
                                    <input class="form-control" name="condition_sensor" type="text" placeholder="{{ __('Ej: 4500L') }}"  required autofocus/>
                                </div>                    
                            </div>
                            ...
                            <div class="row" style="margin-top:30px" >
                                ...
                                <div class="col-sm-3">
                                    <input class="form-control" name="type" type="text" placeholder="2018-20-11 " required="true" aria-required="true" autofocus/>
                                </div>
                            ...
                            <div class="row" style="margin-top:30px">
                                ...
                                <div class="col-sm-3">
                                    <input class="form-control" name="state" type="text" placeholder="Ej: Lugar, Condicion" required="true" aria-required="true" autofocus/>
                                </div>
                                
                                <label for="fk_device" class="col-sm-2 col-form-label" >Tuberia </label>
                                <div class="col-sm-3">
                                <select id="fk_device" name="fk_device" class="form-control">
