...
<div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <form action="{{route('leakages.update',$leakage->id)}}"  method="POST" class="form-horizontal">
                    @csrf
                    @method('PUT')
                    <div class="card ">
                        <div class="card-header card-header-secundary" style="background-color:#F44336">
                            <h4 class="card-title">{{ __('Modificar Fugas') }}</h4>
                        ...
                        <div class="card body">
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <input class="form-control" name="stimad_less" type="text" placeholder="{{ __('Ej: 4500L') }}"  required autofocus value="{{$leakage->stimad_less}}"/>
                                </div>                    
                            </div>
                            ...
                            <div class="row" style="margin-top:30px" >
                                ...
                                <div class="col-sm-3">
                                    <input class="form-control" name="datetime" type="text" placeholder="2018-20-11 " required="true" aria-required="true" autofocus value="{{$leakage->datetime}}"/>
                                </div>
                                
                                <label class="col-sm-2 col-form-label">{{ __('Causa') }}</label>
                                <div class="col-sm-3">
                                    <input class="form-control" name="cause" id="input-password" type="text" placeholder="{{ __('(Opcional)') }}"  required autofocus value="{{$leakage->cause}}"/>
                                </div>                        
                            </div>
                            <div class="row" style="margin-top:30px">
                                <label for="name" class="col-sm-2 col-form-label" style="margin-left:50px" >Detalles</label>
                                <div class="col-sm-3">
                                    <input class="form-control" name="details" type="text" placeholder="Ej: Lugar, Condicion" required="true" aria-required="true" autofocus value="{{$leakage->details}}"/>
                                </div>
